...
const Hero = () => {
  return (
    <>
      ...
      <div className="grid md:grid-cols-6 absolute top-1/2 -translate-y-1/2 z-10">
        <div className="col-start-2 col-span-4 p-6 md:p-0 md:-mr-px text-right">
          ...
          <p className="max-w-lg text-lg mt-6 text-stone-600 dark:text-stone-400 float-right">
            ...
            french start-up. Currently, I am a course assistant for two courses,
            graduate level Web Programming II and Systems Programming.
          </p>
        </div>
      </div>
    </>
