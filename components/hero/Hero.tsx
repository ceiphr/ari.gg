  ...
  return (
    ...
    >
      <div className="col-start-2 col-span-4 p-6 md:p-0">
        ...
        <div className="hero-fade my-2 max-w-xs md:max-w-none rounded-full inline-block overflow-x-auto overflow-y-hidden whitespace-nowrap bg-white dark:bg-black border border-black/20 dark:border-white/20">
