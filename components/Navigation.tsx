    ...
    <div className="fixed w-full p-4 z-20 navigation-backdrop--contrast">
      <nav className="flex sm:justify-center space-x-4">
        ...
        <a
          ...
          rel="noreferrer"
          target="_blank"
          className="button-w-icon rounded-lg px-3 py-2 font-medium text-black dark:text-white dark:hover:bg-white dark:hover:text-black hover:bg-black hover:text-white"
        >
          Resume
